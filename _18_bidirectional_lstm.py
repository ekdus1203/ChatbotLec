...
# 양방향 LSTM 모델 정의
model = Sequential()
# LSTM이 정방향, 역방향 2개층이 생성된다(Bidirectional)
# 정방향의 정보가 역방향 LSTM층에 전달된다(return_sequences=True)
# 정방향과 역방향의 학습정보를 모아서 최종적으로 Dense(1)에 전달한다(TimeDistributed)
...
for epoch in range(1000):
    print("epoch {}/1000".format(epoch + 1))
